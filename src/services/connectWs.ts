...
const defaultUrl = "ws://192.168.0.208:8084/websocket/?request=e2lkOjE7cmlkOjI2O3Rva2VuOiI0MzYwNjgxMWM3MzA1Y2NjNmFiYjJiZTExNjU3OWJmZCJ9"
let socket: WebSocket;

export const connectWs = (url = defaultUrl): Promise<Map<any,any>> => {
    // event.emit
